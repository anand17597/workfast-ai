  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32 flex flex-col md:flex-row items-center justify-between text-center md:text-left z-10 gap-12">
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1579389083395-45572e3d29ae?auto=format&fit=crop&w=1600&q=90"
            alt="Workfast.ai platform interface on a laptop and mobile devices"
