...
const pricingPlans: PricingPlan[] = [
  {
    ...
    users: "Up to 10",
    storage: "10 GB",
    features: ["Kanban Board", "Custom Workflows", "Team Chats", "Recurring Tasks", "Reminders", "Reports", "CSV/PDF Export"],
  ...
  },
  {
    ...
    users: "Up to 25",
    storage: "50 GB",
    features: ["All Starter Features", "Advanced Reports", "Google Calendar Integration", "Custom Fields", "Time Tracking"],
  ...
  },
  {
    ...
    users: "Up to 100",
    storage: "150 GB",
    features: ["All Growth Features", "Admin Dashboard", "User Permissions", "Message Management", "Priority Feature Requests"],
  ...
  },
  {
    ...
    users: "Custom",
    storage: "150 GB+",
    features: ["All Scale Features", "Dedicated Account Manager", "SLA Customization", "On-Premise Deployment Options", "Advanced Security & Compliance"],
...
const Pricing: React.FC = () => {
  ...
  const [isAnnual, setIsAnnual] = useState(false); // Only monthly data provided, toggle is visual
        ...
        >
          <div className="inline-flex bg-gray-100 rounded-full p-1">
            <button
              ...
              className={cn(
                "px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 min-w-[120px]",
                !isAnnual ? "bg-indigo-600 text-white shadow-sm" : "text-gray-700 hover:text-indigo-600"
              )}
            >
              Monthly
            </button>
            ...
            return (
              ...
              >
                ...
                <a
                  ...
                  className="w-full text-center bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-200"
                >
                  {plan.ctaText}
                </a>
              </div>
